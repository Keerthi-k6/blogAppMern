// link tag doesnt reload the page like anchor tag
// while using LINK tag or anytag from react router dom ,you have the wrap the <App/> component in <Browser Router/> component 
...
const Navbar = () => {
  ...
  return (
    ...
    <nav className='navbar z-50'>
        ...
        <img src={theme == "light" ? darkLogo : lightLogo} className='flex-none'/>
        </Link>
         
        <div className={'absolute bg-white w-full left-0 top-full mt-0.5 border-b border-grey py-4 px-[5vw] md:border-0 md:block md:relative md:inset-0 md:p-0 md:w-auto md:show ' + (searchBoxVisibility?'show':'hidden')}>
          <input 
          type='text'
          placeholder='Search'
