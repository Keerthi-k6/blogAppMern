...
const CommentCard = ({index,leftVal,commentData}) => {
    ...
    const handleReplyClick = () => {
      if(!access_token)
      {
        return toast.error("Please login to reply a comment")
      }
    ...
    <div className='w-full' style={{ paddingLeft:`${ leftVal * 10}px`}}>
      <div className="my-5 p-6 rounded-md border border-grey">
       ...
       </button>
       {
        ...
        <button className='p-2 px-3 rounded-md border border-grey ml-auto hover:bg-grey/30 hover:text-red flex items-center' onClick={deleteComments}>
