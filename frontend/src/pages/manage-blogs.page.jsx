...
import {ManageDraftsBlogsPost,ManagePublishBlogsCard} from '../components/manage-blogcard.component'
    ...
    <InPageNavigation routes={["Published Blogs","Drafts"]} defaultActiveIndex={activeTab !='draft' ? 0 : 1}>
        {
            ...
            <>
            {
               blogs.results.map((blog,i)=>
               {
                return <AnimationWrapper key={i} transition={{delay:i * 0.04}}>
                   <ManagePublishBlogsCard blog={{...blog,index:i,setStateFunc:setBlogs}}/>
...

         {
            ...
            <>
            {
               ...
               {
                return <AnimationWrapper key={i} transition={{delay:i * 0.04}}>
                   <ManageDraftsBlogsPost blog={{...blog,index:i,setStateFunc:setDrafts}}/>
            ...
            :
            <NoDataMessage message = "No draft blogs found"/>
        }
